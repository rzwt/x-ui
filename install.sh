...
download_xui(){
    ...
    wget -N --no-check-certificate -O /usr/local/x-ui-linux-$(archAffix).tar.gz https://github.com/rzwt/x-ui/raw/main/x-ui-linux-$(archAffix).tar.gz
    if [[ $? -ne 0 ]]; then
    ...
    wget -N --no-check-certificate https://github.com/rzwt/x-ui/raw/main/x-ui.sh -O /usr/bin/x-ui
